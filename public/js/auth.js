...
if (loginForm) {
  ...
  loginForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      const res = await axios.post('https://charity-app-5acl.onrender.com/api/auth/login', { email, password });
...
if (registerForm) {
  registerForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      const res = await axios.post('https://charity-app-5acl.onrender.com/api/auth/register', { name, email, password,role });
