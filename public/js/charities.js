...
async function fetchCharities() {
  ...
  try {
    const response = await axios.get(`https://charity-app-olh6.onrender.com/allcharities?${queryString}`);
...
async function donate(projectid, charityid) {
  try {
    ...
    const response = await axios.get(`https://charity-app-olh6.onrender.com/donations/donation/${amount * 100}/${projectid}/${charityid}`, {
    ...
    var options = {
      ...
      "handler": async function (response) {
        try {
          await axios.post(`https://charity-app-olh6.onrender.com/donations/updateTransactionStatus/${amount}/${projectid}/${charityid}`, {
