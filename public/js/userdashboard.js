...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        const response = await axios.get("https://charity-app-olh6.onrender.com/api/auth/profile", {
    ...
    updateForm.addEventListener("submit", async (e) => {
        ...
        try {
            const updateResponse = await axios.put("https://charity-app-olh6.onrender.com/api/auth/profile", updatedUser, {
                headers: { Authorization: token },
            });
