...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    const response = await axios.get('https://charity-app-olh6.onrender.com/allcharities');
...
async function deleteProject(projectid) {
  ...
  try {
    ...
    const res = await axios.delete(`https://charity-app-olh6.onrender.com/deleteproject/${projectid}`, {  headers: { Authorization: token } });
