...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        const response = await axios.get("https://charity-app-olh6.onrender.com/api/auth/charityprofile", {
    ...
    updateForm.addEventListener("submit", async (e) => {
        ...
        try {
            const updateResponse = await axios.put("https://charity-app-olh6.onrender.com/api/auth/charityprofile", updatedcharity, {
                headers: { Authorization: token },
            });
