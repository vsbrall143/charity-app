...
if (loginForm) {
  loginForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      const res = await axios.post('https://charity-app-olh6.onrender.com/api/auth/charitylogin', { email, password }); 
      console.log(res);
...
if (registerForm) {
  registerForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      const res = await axios.post('https://charity-app-olh6.onrender.com/api/auth/charityregister', { 
        name, 
        email, 
        password, 
        mission, 
